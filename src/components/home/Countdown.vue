<template>
  <span>
    <p v-if="msTime.show" class="countdown">
      <span v-if="tipShow" class="startText">{{tipText}}:</span>
      <span v-if="!tipShow" class="endText">{{tipTextEnd}}:</span>
      <span v-if="msTime.day>0">
        <span>{{msTime.day}}</span>
        <i class="dayText text">{{dayTxt}}</i>
      </span>
      <span>{{msTime.hour}}</span>
      <i class="hourText text">{{hourTxt}}</i>
      <span>{{msTime.minutes}}</span>
      <i class="minuteText text">{{minutesTxt}}</i>
      <span>{{msTime.seconds}}</span>
      <i class="secondText text">{{secondsTxt}}</i>
    </p>
